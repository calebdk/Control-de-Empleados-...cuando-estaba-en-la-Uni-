...
namespace proyecto_DR_roque
{
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                { //no hay datos para mostrar
                    MessageBox.Show("no hay Empleados para mostrar", "Error");
                }
                //cerrar la conexion
                cn.Close();
            }
            ...
            {
                MessageBox.Show("Debe ingresar algun dato de un Empleado", "Error");
            }
        }
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            conexion.ConnectionString = "provider = Microsoft.Ace.Oledb.12.0; data source = " + Application.StartupPath + @"\proyectoroque1.accdb";
